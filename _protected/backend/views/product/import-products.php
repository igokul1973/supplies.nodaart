...
<h2 style="margin-top: 50px;">
   Please correct the above listed errors in the specified rows in the import file, <?= Html::a('return back to the previous page', 'index'); ?>, and recommit the spreadsheet.  
</h2>